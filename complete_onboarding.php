...
<div class="w-full max-w-7xl bg-white p-8 rounded-xl shadow-xl">
    <h2 class="text-2xl font-bold text-center text-gray-700 mb-4">Please complete your information</h2>
    ...
    <form id="multiStepForm" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="form-step active grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select onchange="fetchLgas(this.value)" required
                    class="form-control w-full border border-gray-300 rounded-lg p-2 select2" name="merchant_state"
                    id="merchant_state">
            ...
            <div>
                ...
                <select class="form-control w-full border border-gray-300 rounded-lg p-2 select2" name="merchant_lga"
        ...
        <div class="form-step hidden grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <div class="relative w-32 h-32 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 cursor-pointer hover:border-cyan-400 transition group"
                    onclick="document.getElementById('merchant_logo').click()">
                    ...
                    <span id="logoPlaceholder" class="text-gray-400 flex flex-col items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mb-1" fill="none" viewBox="0 0 24 24"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7M16 3H8a2 2 0 00-2 2v0a2 2 0 002 2h8a2 2 0 002-2v0a2 2 0 00-2-2z" />
                        </svg>
                        <span class="text-xs">Click to upload</span>
                    </span>
                    <button type="button" id="removeLogoBtn"
                        class="hidden absolute top-1 right-1 bg-white rounded-full p-1 shadow hover:bg-gray-100"
                ...
                <input type="file" required class="hidden" id="merchant_logo" name="merchant_logo" accept="image/*"
        ...
        <div class="form-step hidden grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <div class="relative w-32 h-32 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 cursor-pointer hover:border-cyan-400 transition group"
                    onclick="document.getElementById('cac_document').click()">
                    <img id="cacPreview" src="#" alt="CAC Preview"
                        class="hidden absolute inset-0 w-full h-full object-contain rounded-lg" />
                    <span id="cacPlaceholder" class="text-gray-400 flex flex-col items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mb-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 17v-2a4 4 0 014-4h2a4 4 0 014 4v2M7 7a4 4 0 018 0v4a4 4 0 01-8 0V7z" />
                        </svg>
                        <span class="text-xs">Click to upload</span>
                    </span>
                    <span id="cacFileName"
                        class="hidden absolute bottom-1 left-1 right-1 text-xs text-gray-500 bg-white bg-opacity-80 rounded px-1 py-0.5"></span>
                    <button type="button" id="removeCacBtn"
                        class="hidden absolute top-1 right-1 bg-white rounded-full p-1 shadow hover:bg-gray-100"
                ...
                <input type="file" required class="hidden" id="cac_document" name="cac_document"
...
<script>
    ...
    function previewImage(input, previewId, placeholderId, removeBtnId, type = 'logo') {
        ...
        if (!errorSpan) {
            ...
            errorSpan.className =
                'file-error text-xs text-red-500 absolute bottom-1 left-1 right-1 bg-white bg-opacity-80 rounded px-1 py-0.5';
