       ...
       <div class="row" style="<?php echo ($operation == "edit")?"display:none":""; ?>">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="text" name="username" <?php echo ($operation == "edit")?"disabled":""; ?> class="form-control" value="<?php echo ($operation == "edit") ? $username : ""; ?>" placeholder="" autocomplete="off">
           ...
           <div class="col-sm-6">
               <div class="form-group ">
                    ...
                    <div class="input-group">
                        <input type="password" <?php echo ($operation == "edit")?"disabled":""; ?>  autocomplete="off" name="password" value="<?php echo ($operation == "edit") ? $church[0]['date_of_inception'] : ""; ?>" id="password" class="form-control" autocomplete="off" />
            ...
            {
            ?>
                <input type="hidden" name="username" class="form-control" value="<?php echo $username; ?>" placeholder="" autocomplete="off">
            <?php
            }
           ?>
         <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="text" name="firstname" value="<?php echo ($operation == "edit") ? $user[0]['firstname'] : "" ?>" class="form-control" autocomplete="off">
                </div>
           </div>
           <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">Last Name<span class="asterik">*</span></label>
                    <input type="text" name="lastname" value="<?php echo ($operation == "edit") ? $user[0]['lastname'] : "" ?>" class="form-control" autocomplete="off">
                </div>
           </div>
        </div>
        <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="number" name="mobile_phone" value="<?php echo ($operation == "edit") ? $user[0]['mobile_phone'] : "" ?>" class="form-control" autocomplete="off">
                </div>
           </div>
           <div class="col-sm-6">
               <div class="form-group">
            ...
            <div class="row" id="bank_details" style="<?php ($operation=="edit")?($user[0]['parish_pastor']==1)?"display:block":"display:none":"display:block"; ?>">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="number" onkeyup="fetchAccName(this.value)"  name="account_no" value="<?php echo $user[0]['account_no'] ?>" class="form-control" placeholder="" autocomplete="off">
                        <small id="acc_name"><?php echo ($operation == "edit") ? $user[0]['account_name'] : ""; ?></small>
                    </div>
                </div>
            </div>
        </div>
