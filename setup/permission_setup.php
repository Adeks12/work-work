            ...
            <form id="form1" method="POST" class="simple-example" enctype="multipart/form-data" action="javascript:void(0);" novalidate autocomplete="off">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="_cors_" id="_cors_" value="<?php echo isset($_SESSION['eagle_cors_token_sess']) ? $_SESSION['eagle_cors_token_sess'] : '' ?>">
                        ...
                        <div class="hide">
                            <div class="row py-2">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 py-2">
                                    ...
                                    <input type="text" class="form-control" id="action" placeholder="Enter operation(op)" name="action" value="<?php echo isset($_REQUEST['op']) ? $permissions[0]['action'] : '' ?>">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 py-2">
                                    <label class="form-label">Label</label>
                                    <input type="text" class="form-control" id="label" placeholder="Enter label" name="label" value="<?php echo isset($_REQUEST['op']) ? $permissions[0]['label'] : '' ?>">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 py-2">
                                    <label class="form-label">Operation Type </label>
                                    <select class="form-control select" name="operation_type" id="operation_type">
                                        <?php echo (isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit') ? '<option value="' . $permissions[0]['operation_type'] . '">' . ucfirst($permissions[0]['operation_type'] . ' Operations') . '</option>' : '';
                                        ?>
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 py-2">
                                    ...
                                    <textarea class="form-control" name="description" rows="2" placeholder="Enter Description"><?php echo (isset($_REQUEST['op']) == 'edit') ? $permissions[0]['description'] : ''; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="text-center py-2 mb-0">
                                <button id="save_facility" onclick="savePermissions()" name="subbtn" class="btn btn-primary"><i class=" fas fa-save"></i> Save Record </button>
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success: function(re) {
                ...
                if (re.response_code == 0) {
                    $("#save_facility").html('<i class="fas fa-save"></i> Save Record');
