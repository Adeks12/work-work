...
$user_roles = $dbobject->db_query($sql);
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 pb-3">
                <div class="row">
                    <div class="form-group col-lg-5 col-md-12 col-sm-12">
                        <label for="role_id" class="input_label">Role Name</label>
                    ...
                    <div class="row py-3">
                        ...
                        <div class="row py-2">
                            <div class="form-group col-lg-5 col-md-5 col-sm-12">
                                <button class="btn btn-primary btn-style mt-4 save"><span class="fas fa-save save-icon"></span><span class="fa fa-spin fa-spinner saving-icon" style="display: none;"></span>
    ...
    $(document).ready(function() {
        ...
        $(".save").click(function(e) {
            ...
            if (role != "") {
                ...
                $.post(
                    "utilities.php?op=Permissions.saveActions&role_id=" + $("#role_id").val(),
                    form,
                    function(data) {
                        ...
                        if (data.response_code == 0) {
                            $(".saving-icon").hide();
                            $(".save-icon").hide();
                            $(".save-text").html('<span class="fas fa-save"></span> Saved');
                            $(".msg")
                                .html(
                            ...
                            $(".save-icon").show();
                            $(".save-text").html(
                                '<span class="fas fa-save save-icon"></span> Save'
                            );
                        }
                    },
                    "json"
