...
<!-- Mirrored from appstack.bootlab.io/auth-sign-in by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Aug 2024 10:50:00 GMT -->
...
<body>
	<div class="auth-full-page d-flex">
		<div class="auth-form p-3">
			...
			<div class="mb-3">
				<div class="d-grid gap-2 mb-3">
					<a class='btn btn-facebook btn-lg position-relative shadow' href='dashboard-default-2.html'>
      ...
      <span class="position-absolute mx-auto w-100 left-0">Continue with Facebook</span>
					...
					<a class='btn btn-google btn-lg position-relative shadow' href='dashboard-default-2.html'>
      ...
      <span class="position-absolute mx-auto w-100 left-0">Continue with Google</span>
					...
					<a class='btn btn-apple btn-lg position-relative shadow' href='dashboard-default-2.html'>
      ...
      <span class="position-absolute mx-auto w-100 left-0">Continue with Apple</span>
        ...
        <a href='auth-reset-password.html'>Forgot password?</a>
					...
					<div class="d-grid gap-2 mt-3">
						<a class='btn btn-lg btn-primary' href='dashboard-default-2.html'>Sign in</a>
					</div>
				</form>
			</div>
