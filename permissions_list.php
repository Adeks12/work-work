                    ...
                    <div class="card-header col-lg-12" style="border-bottom: 1px solid #228b22 !important">
                        <div class="row ">
                            ...
                            <div class="col-lg-6 text-right">
                                <button id="save_facility9" onclick="getpage('setup/permission_map.php', 'page')" name="subbtn" class="btn btn-warning"><i class=" fas fa-gear"></i> Map Permission </button>
                                &nbsp;
                                <button id="save_facility10" onclick="myLoadModal('setup/permission_setup.php', 'modal_div')" name="subbtn" class="btn btn-primary"><i class=" fas fa-plus"></i> Add Permission </button>
                            </div>
                        </div>
                    </div>

                </div>
                <table class="table table-responsive table-hover table-striped table-bordered pull-left col-lg-12" id="datatables-ajax" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>Sn</th>
                            <th>Operation</th>
