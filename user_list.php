...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            ?>
                <div class="col-sm-2">
                    <a class="btn btn-warning" onclick="loadModal('setup/pastor.php','modal_div')" href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary">Create User</a>
                </div>
            <?php
            }
            ?>
